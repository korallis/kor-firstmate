...
FM_COMPOSER_IDLE_RE='Add a follow-up'    # empty-composer placeholder regex, applied after dim-ghost and border stripping (default matches cursor's idle placeholder; override to extend)
